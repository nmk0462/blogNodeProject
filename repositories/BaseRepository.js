...
class BaseRepositoryContract extends RepositoryContract {
     ...
     * @return mixed
     */
    update(attributesToUpdate, findCriteria = {}, individualHooks = false) {
        return this.model.update(attributesToUpdate, findCriteria, individualHooks)
            .then(res => res);
    }
    ...
    all(findCriteria = {}, populate = null) {
        ...
        return this.model.findAll(findCriteria);
    }
    ...
    getLengthAwarePaginatorInstance(modelObjects, total, limit = null, page = null) {
        const LengthAwarePaginator = require('../helpers/LengthAwarePaginator');
    ...
    get(id, populate = true) {
        let modelQuery = this.model.findByPk(id);
    ...
    findOrCreate(attributes = {}) {
        return this.model.findOrCreate({where: attributes});
    }
